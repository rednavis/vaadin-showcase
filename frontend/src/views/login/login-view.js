...
class LoginView extends PolymerElement {
  static get template() {
    return html`
      ...
      <hr>
      <iron-icon icon="inline:google" id="google-icon" role="img" aria-label="Google"></iron-icon>
      <iron-icon icon="inline:facebook" id="facebook-icon" role="img" aria-label="Facebook"></iron-icon>
      <iron-icon icon="inline:twitter" id="twitter-icon" role="img" aria-label="Twitter"></iron-icon>
      <hr>
